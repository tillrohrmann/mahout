...
import org.apache.mahout.flinkbindings.blas.AewB
import org.apache.mahout.flinkbindings.drm.CheckpointedDrmFlink
import scala.reflect.ClassTag
import org.apache.mahout.math.{VectorWritable, RandomAccessSparseVector, Vector, Matrix}
import collection.JavaConversions._

class FlinkEngine(val context: FlinkDistributedContext) extends DistributedEngine {
  ...
  override def toPhysical[K: ClassTag](plan: DrmLike[K], ch: CacheHint.CacheHint): CheckpointedDrm[K] = {
    ...
    new CheckpointedDrmFlink[K](drmDS, context)
  }
  ...
  override def drmFromHDFS(path: String, parMin: Int)(implicit ctx: DistributedContext): CheckpointedDrm[_] = {
    null
  }
  ...
  override def drmParallelizeWithRowIndices(m: Matrix, numPartitions: Int = 1)
    ...
    new CheckpointedDrmFlink[Int](ds, ctx)
  }
  ...
  override def drmParallelizeWithRowLabels(m: Matrix, numPartitions: Int = 1)
    ...
    new CheckpointedDrmFlink[String](ds, ctx)
  }
  ...
  override def drmParallelizeEmptyLong(nrow: Long, ncol: Int, numPartitions: Int = 10)
    ...
    new CheckpointedDrmFlink[Long](ds, ctx)
  }
